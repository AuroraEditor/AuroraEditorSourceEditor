...
public struct CursorPosition: Sendable, Codable, Equatable {
    ...
    /// The range value, however, be filled when updated by ``AuroraEditorSourceEditor`` via a `Binding`, or when it appears
    ...
    /// to `-1`. They will, however, be filled when updated by ``AuroraEditorSourceEditor`` via a `Binding`, or when it
