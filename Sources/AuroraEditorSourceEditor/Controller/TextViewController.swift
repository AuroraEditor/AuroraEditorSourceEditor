...
/// # TextViewController
///
/// A view controller class for managing a source editor. Uses ``AuroraEditorTextView/TextView`` for input and rendering,
...
public class TextViewController: NSViewController {
    ...
    internal var _undoManager: AEUndoManager?
